        ...
        >
          <div>
            <motion.span variants={fadeIn()}>
              <h1
                data-scroll
                className="mid-head3 xs:text-4xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-5xl text-4xl  mt-8 font-normal leading-tight text-gray-300 xs:pl-5 sm:pl-5 md:pl-24 lg:pl-36 xl:pl-80 xs:pr-0 sm:pr-0 md:pr-20 lg:pr-40 xl:pr-40 pr-0 xs:text-center sm:text-center md:text-right lg:text-right xl:text-right text-center"
              >
                Meet the Deviants
              </h1>
            </motion.span>
          ...
          <div className="flex flex-col xs:mt-12 sm:mt-12 md:mt-12 lg:mt-10 xl:mt-10 mt-12 xs:w-full sm:w-full md:w-full lg:w-full xl:w-full w-full items-righttext-right ml-auto mr-28">
            <div className="lg:flex-grow w-full  flex flex-col lg:items-start md:text-left items-center text-right">
              <div className="flex xs:flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row flex-col w-full">
                <div className="flex flex-start place-items-start mb-10 lg:mb-0 xs:w-full sm:w-full md:w-full lg:w-1/2 xl:w-1/2 w-full xs:pr-0 sm:pr-5 md:pr-12 lg:pr-0 xl:pr-0 pr-0 ">
                  {/* Looping video goes here */}
                  <img
                    data-scroll
                    className="rounded-xl object-cover object-center mid-img3 z-10 xs:w-full sm:w-4/5 md:w-4/5 lg:w-4/5 xl:w-4/5 w-full xs:p-0 sm:p-0 md:p-6 lg:p-6 xl:p-6 p-0 ml-auto -mt-2"
                    alt="hero"
                    src={about}
                  />
                  {/* <video
