      ...
      <div className="mx-auto py-16  md:px-12 px-4 lg:px-8 w-full">
        <div className="space-y-12">
          <div className="space-y-5 text-center sm:space-y-4">
            <h2 className="tk-roma font-title sm:text-5xl text-4xl title-font font-bold text-teal-300 ">
              Meet Our Team
            </h2>
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-center items-center text-center relative h-1/10 flex-1">
                      <div className="leading-6 h-full flex flex-col justify-between">
                        ...
                        <motion.span className="text-center flex justify-center items-center p-4">
                          <a
