    ...
    return (
        ...
        >
            <video
                ...
                loop
                muted
                className="absolute z-10 w-auto md:min-w-full md:min-h-full md:max-w-none w-screen xs:p-0 sm:p-0 md:p-10 lg:p-20 xl:p-20 p-0 xs:mb-40 sm:mb-40 md:mb-32 lg:mb-28 xl:mb-28 mb-40"
            >
