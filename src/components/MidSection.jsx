  ...
  return (
    <div className="w-full text-white py-8 px-4">
      <div className="max-w-[1240px] mx-auto text-center flex flex-col">
        <h1 class=" sm:text-[34px] text-2xl font-extrabold leading-5">
        ...
        >
          <motion.span variants={fadeIn()}>
            <h1 class=" sm:text-[34px] text-2xl font-extrabold mt-8">
              The Fate of the Universe is in your Hands.
            </h1>
          </motion.span>
          <div className="max-w-[700px] sm:mx-[50px] md:mx-[100px] lg:mx-[280px] my-8">
            <motion.span variants={fadeIn()}>
              <p className="text-base text-[#595959] font-normal leading-6 my-4 ">
